...
namespace WindowsAzure.Storage.Replicate
{
    public class Hash
    {
        public static string MD5(string input)
        {
            ...
            var bytes = hashString.ComputeHash(message);

            return Base32Url.ToBase32String(bytes);
        }
        ...
        public class Base32Url
        {
            ...
            public const string Base32StandardAlphabet = "abcdefghjkmnpqrstvwxyz1234567890";
